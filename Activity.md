...
# 某大型攻防演练活动中，以下产品(或者 附文档中提到的行业中有重点使用的产品)的 1day漏洞将会重点关注！（1day定义：指已被披（透）露相关漏洞信息（如漏洞基本信息、临时解决方案等）、官方已发布对应修复程序（如：补丁或者无此漏洞的迭代版本）或从工具中捕获的漏洞，但是漏洞细节、POC、EXP等并未被公开的一种漏洞）
